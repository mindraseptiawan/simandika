...
class FormKandangPage extends StatefulWidget {
  ...
  const FormKandangPage({super.key, this.kandang});

  @override
  FormKandangPageState createState() => FormKandangPageState();
}

class FormKandangPageState extends State<FormKandangPage> {
