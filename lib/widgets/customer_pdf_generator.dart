...
Future<Uint8List> generateCustomerPDF(
  ...
  List<CustomerModel> filteredCustomers = allcustomers
      .where((customer) =>
          customer.createdAt.isAfter(startDate.subtract(Duration(days: 1))) &&
          customer.createdAt.isBefore(endDate.add(Duration(days: 1))))
      .toList();
    ...
    pw.MultiPage(
      ...
      build: (pw.Context context) {
        return [
          ...
          pw.SizedBox(height: 20),
          pw.Text(
            'Total Customer: ${filteredCustomers.length}',
